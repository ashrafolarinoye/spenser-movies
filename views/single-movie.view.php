                ...
                <div class="uk-container uk-container-center uk-width-10-10">
                    ...
                    <div class="uk-grid">
                        ...
                        <?php if(!isWatch()): ?>
                            ...
                            <?php if(isLogged()): ?>
                            <a class="uk-button uk-button-primary uk-button-large uk-width-1-1 uk-margin-top" href="<?php echo gotToWatch(); ?>"><i class="uk-icon-television uk-margin-small-right"></i> <?php echo _WATCHNOW ?>
                            </a>
                            <?php endif; ?>
